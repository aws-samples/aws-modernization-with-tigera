...
{{% notice warning %}}
Make sure you are naming your Cloud9 environment `tigera-workshop`, otherwise things will break later.
{{% /notice %}}

1. Select **Create environment**
2. Name it **tigera-workshop** and click **Next Step**
...
![create-workspace](/images/cloud9-manage-ec2.png)
